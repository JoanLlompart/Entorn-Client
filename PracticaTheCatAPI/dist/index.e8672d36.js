...
})({"1YoAR":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6b7f405be8672d36";
"use strict";
...
},{}],"caqVB":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function() {
    ...
    selectElement.addEventListener("change", function() {
        ...
        fetch(`https://api.thecatapi.com/v1/images/search?breed_ids=${selectedBreedId}`).then((response)=>response.json()).then((data)=>{
            // Verificar si se recibió una respuesta válida
            if (data && data.length > 0) {
                const imageUrl = data[0].url;
                // Mostrar la imagen en el elemento de la imagen
                imatgeCat.src = imageUrl;
            } else console.error("No se pudo obtener la imagen de la raza seleccionada.");
        }).catch((error)=>console.error("Error al obtener la imagen de la raza seleccionada:", error));
    });
});

},{}]},["1YoAR","caqVB"], "caqVB", "parcelRequired1fa")

//# sourceMappingURL=index.e8672d36.js.map
