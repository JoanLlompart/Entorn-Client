document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Selecciona una opción en breedsSelect
    ...
    // Llena el elemento breedsSelect con las opciones de razas
    ...
    // Escucha el evento de cambio en breedsSelect para actualizar la vista
    ...
    // Despacha un evento de cambio en breedsSelect al cargar la página para inicializar la vista
